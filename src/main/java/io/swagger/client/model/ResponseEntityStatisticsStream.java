...
public class ResponseEntityStatisticsStream   {
...
public enum StatusCodeEnum {
  ...
  private StatisticsStream body = null;
  ...
  @ApiModelProperty(value = "")
  @JsonProperty("body")
  public StatisticsStream getBody() {
    return body;
  }
  public void setBody(StatisticsStream body) {
    this.body = body;
  }
  ...
  public String toString()  {
    ...
    sb.append("class ResponseEntityStatisticsStream {\n");
