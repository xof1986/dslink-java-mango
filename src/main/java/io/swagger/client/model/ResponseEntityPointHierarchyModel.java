...
public class ResponseEntityPointHierarchyModel   {
...
public enum StatusCodeEnum {
  ...
  private PointHierarchyModel body = null;
  ...
  @ApiModelProperty(value = "")
  @JsonProperty("body")
  public PointHierarchyModel getBody() {
    return body;
  }
  public void setBody(PointHierarchyModel body) {
    this.body = body;
  }
  ...
  public String toString()  {
    ...
    sb.append("class ResponseEntityPointHierarchyModel {\n");
