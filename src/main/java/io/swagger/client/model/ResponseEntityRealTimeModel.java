...
public class ResponseEntityRealTimeModel   {
...
public enum StatusCodeEnum {
  ...
  private RealTimeModel body = null;
  ...
  @ApiModelProperty(value = "")
  @JsonProperty("body")
  public RealTimeModel getBody() {
    return body;
  }
  public void setBody(RealTimeModel body) {
    this.body = body;
  }
  ...
  public String toString()  {
    ...
    sb.append("class ResponseEntityRealTimeModel {\n");
