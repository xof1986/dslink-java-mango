...
public class ResponseEntityListUserModel   {
...
public enum StatusCodeEnum {
  ...
  private List<UserModel> body = new ArrayList<UserModel>();
  ...
  @ApiModelProperty(value = "")
  @JsonProperty("body")
  public List<UserModel> getBody() {
    return body;
  }
  public void setBody(List<UserModel> body) {
    this.body = body;
  }
  ...
  public String toString()  {
    ...
    sb.append("class ResponseEntityListUserModel {\n");
