...
public class ResponseEntityListDataPointModel   {
...
public enum StatusCodeEnum {
  ...
  private List<DataPointModel> body = new ArrayList<DataPointModel>();
  ...
  @ApiModelProperty(value = "")
  @JsonProperty("body")
  public List<DataPointModel> getBody() {
    return body;
  }
  public void setBody(List<DataPointModel> body) {
    this.body = body;
  }
  ...
  public String toString()  {
    ...
    sb.append("class ResponseEntityListDataPointModel {\n");
