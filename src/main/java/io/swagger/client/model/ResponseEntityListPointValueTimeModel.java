...
public class ResponseEntityListPointValueTimeModel   {
...
public enum StatusCodeEnum {
  ...
  private List<PointValueTimeModel> body = new ArrayList<PointValueTimeModel>();
  ...
  @ApiModelProperty(value = "")
  @JsonProperty("body")
  public List<PointValueTimeModel> getBody() {
    return body;
  }
  public void setBody(List<PointValueTimeModel> body) {
    this.body = body;
  }
  ...
  public String toString()  {
    ...
    sb.append("class ResponseEntityListPointValueTimeModel {\n");
