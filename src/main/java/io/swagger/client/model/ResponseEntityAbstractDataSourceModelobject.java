...
public class ResponseEntityAbstractDataSourceModelobject   {
...
public enum StatusCodeEnum {
  ...
  private AbstractDataSourceModelobject body = null;
  ...
  @ApiModelProperty(value = "")
  @JsonProperty("body")
  public AbstractDataSourceModelobject getBody() {
    return body;
  }
  public void setBody(AbstractDataSourceModelobject body) {
    this.body = body;
  }
  ...
  public String toString()  {
    ...
    sb.append("class ResponseEntityAbstractDataSourceModelobject {\n");
