...
public class ResponseEntityJsonArrayStream   {
  ...
  private JsonArrayStream body = null;
  ...
  @ApiModelProperty(value = "")
  @JsonProperty("body")
  public JsonArrayStream getBody() {
    return body;
  }
  public void setBody(JsonArrayStream body) {
    this.body = body;
  }
  ...
  public String toString()  {
    ...
    sb.append(/*"class ResponseEntityJsonArrayStream */"{\n");
