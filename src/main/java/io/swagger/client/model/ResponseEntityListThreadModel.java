...
import java.util.*;
import io.swagger.client.model.ThreadModel;
...
public class ResponseEntityListThreadModel   {
...
public enum StatusCodeEnum {
  ...
  private List<ThreadModel> body = new ArrayList<ThreadModel>();
  ...
  @ApiModelProperty(value = "")
  @JsonProperty("body")
  public List<ThreadModel> getBody() {
    return body;
  }
  public void setBody(List<ThreadModel> body) {
    this.body = body;
  }
  ...
  public String toString()  {
    ...
    sb.append("class ResponseEntityListThreadModel {\n");
