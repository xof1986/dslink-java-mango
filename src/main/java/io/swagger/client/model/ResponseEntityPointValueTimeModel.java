...
public class ResponseEntityPointValueTimeModel   {
...
public enum StatusCodeEnum {
  ...
  private PointValueTimeModel body = null;
  ...
  @ApiModelProperty(value = "")
  @JsonProperty("body")
  public PointValueTimeModel getBody() {
    return body;
  }
  public void setBody(PointValueTimeModel body) {
    this.body = body;
  }
  ...
  public String toString()  {
    ...
    sb.append("class ResponseEntityPointValueTimeModel {\n");
