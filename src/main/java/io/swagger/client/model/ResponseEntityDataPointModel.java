...
public class ResponseEntityDataPointModel   {
  ...
  private DataPointModel body = null;
  ...
  @ApiModelProperty(value = "")
  @JsonProperty("body")
  public DataPointModel getBody() {
    return body;
  }
  public void setBody(DataPointModel body) {
    this.body = body;
  }
  ...
  public String toString()  {
    ...
    sb.append("class ResponseEntityDataPointModel {\n");
